...
<section class="carousel slider1 slide testimonials-slider cid-sptTkkdgGo" data-interval="false" id="slider1-67">
                        ...
                        <div class="col-lg-5 col-12">
                            <div class="card-wrap">
                                <h1 class="mbr-section-title align-center mbr-fonts-style display-5">
                                    Aide de 500 € attribuée pour la création d’un site internet : au delà du geste, la  réalité de la dépense
                                </h1>
                                <p class="mbr-fonts-style block-quote display-7" style="text-align:justify;">
                                    ...
                                    (plus d’explications sur le dispositif <a class="texteIci" target="_blank" href="https://cheque.francenum.gouv.fr/ecom/">ici</a>).  
                                </p>
                            </div>
                        </div>
                    </div>
...
<section class="mbr-section extContent cid-sptTkkMweF" id="extContent15-68">
        ...
        <div class="row justify-content-center">
            <div class="col-md-10 col-sm-12 text-section">
                <p class="mbr-fonts-style mbr-text align-center display-7" style="text-align:justify;">
                    D’une part, cette subvention a pour vocation de permettre de combler une partie des pertes de chiffre d’affaires des commerçants et 
                    entrepreneurs dans un contexte de crise sanitaire imposant notamment une fermeture physique des locaux commerciaux afin de respecter les 
                    gestes barrière.
                    <br>
                    <br>D’autre part, elle va aussi - et surtout ! - permettre de pouvoir couvrir une partie des frais engagés par le commerçant et l’artisan dans 
                    la création d’une “vitrine” internet, le fameux “site internet pour le e-commerce” résultant de la numérisation des opérations 
                    vendeur-client-fournisseur-livreur…
                    <br>
                    <br>Car après l’expérience financière déplorable induite par le confinement imposé entre mars et mai 2020, les acteurs du commerce ont 
                    très vite compris qu’il leur était d’un intérêt primordial, sinon vital, de digitaliser leur outil de travail, en faisant migrer la 
                    vente directe vers la vente en ligne, avec retrait des achats en “click and collect”, pour citer l’opération la plus connue car 
                    fondamentalement nécessaire et utilisée.
                    <br>
                    <br>Force est de constater que beaucoup d’entreprises se sont alors trouvées confrontées à des problèmes majeurs pour la mise en place 
                    rapide d’une solution numérique, car concevoir, développer, exploiter et maintenir un site internet réclame, pour le néophyte qui s’y 
                    attelle, des compétences pointues en codage informatique et en connaissance des réseaux notamment, bien au delà de la simple acquisition 
                    du matériel (PC, location de l’hébergeur, etc... )
                    <br>
                    <br>Les prestataires numériques qui confectionnent et livrent au commerçant son site de e-commerce, en l’aidant si besoin à 
                    l’exploiter et à le développer, sont nombreux sur le marché, le choix est donc large et certainement adapté à chaque besoin. 
                    Mais un problème de taille est alors soulevé:  le ticket d’entrée de cette migration vers les outils de commerce numérique est 
                    parfois si onéreux qu’il peut rester carrément inaccessible pour une grande majorité de postulants à la numérisation de leur business! 
                    <br>
                    ...
                    Notre politique tarifaire lisible et bien documentée permettra aussi d’éviter les “surprises” de dernière minute, sur la base d’engagements 
                    respectueux des détails qui inspireront confiance, sécurité et sûreté. Évidemment, un site internet est un outil d’un grand intérêt, même 
                    dans un contexte hors crise sanitaire: contact facilité avec les clients, tant au niveau des commandes, des livraisons et des prospects, 
                    réduction des coûts publicitaires et de chalandise, la liste des avantages est très longue…! 
                    <br>
                    <br>Souhaitons pour conclure cet article que cette subvention puisse également permettre à plus ou moins court terme aux PME françaises de 
                    rattraper leur retard par rapport à leurs homologues des autres pays européens, pour qui l’implantation en sites internet se situe à un 
...
<section class="cid-sptVz2gjpD" id="title01-6d">
...
<section class="mbr-section extContent cid-sptTklljW4" id="extContent15-6a">
        ...
        <div class="row justify-content-center">
            <div class="col-md-10 col-sm-12 text-section">
                <p class="mbr-fonts-style mbr-text align-center display-7" style="text-align:justify;">
                    ...
                    <br>
                    <br>Les conditions d’attribution concernent : 
                    <br>- 1° Elles emploient moins de onze salariés. Ce seuil est calculé selon les modalités prévues par le I de l'article L. 130-1 du code de la sécurité sociale ;
                    <br>- 2° Elles ont débuté leur activité avant le 30 octobre 2020 ;
                    <br>- 3° Elles ont fait l'objet d'une interdiction d'accueil du public à partir du 30 octobre 2020 en application du décret du 29 octobre 2020 susvisé. Cette condition ne s'applique pas aux personnes qui exercent leur activité principale dans le secteur des hôtels et hébergements similaires ;
                    <br>- 4° Elles sont inscrites au registre du commerce et des sociétés ou au répertoire des métiers ;
                    <br>- 5° Elles sont à jour de leurs obligations à l'égard de l'administration fiscale et de l'organisme de recouvrement des cotisations patronales de sécurité sociale ;
                    <br>- 6° Elles n'ont pas été déclarées en situation de liquidation judiciaire au jour de la demande d'aide ;
                    ...
                    Retrouvez le décret <a class="texteIci" target="_blank" href="https://www.legifrance.gouv.fr/jorf/id/JORFTEXT000043059724">ici</a>.
                </p> 
            </div>
        </div>
    </div>
...
<section class="cid-sptWZPFavM" id="title01-6e">
    <div class="container align-center">
        <div class="row justify-content-md-start">
...
<section class="mbr-section extContent cid-sptX6eku83" id="extContent15-6g">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10 col-sm-12 text-section">
                <p class="mbr-fonts-style mbr-text align-center display-7" style="text-align:justify;">
...
<section class="clients cid-sptTklEi4y" id="clients01-6b">
