                        ...
                        <div class="plan col-12 justify-content-center col-lg-4">
                            <div class="card2">
                                ...
                                <div class="plan-body">
                                    <div class="plan-list align-center">
                                        <ul class="list-group list-group-flush mbr-fonts-style display-7">
                                            <li class="list-group-item">Site Internet WordPress</li>
                                            <li class="list-group-item">Fiche Google My Business</li>
                                            <li class="list-group-item">Google Analytics</li>
                                            <li class="list-group-item">Nom de domaine &amp; e-mails (inclus)</li>
                                            <li class="list-group-item">Hébergement &amp; maintenance (inclus)</li>
                                ...
                                <div class="plan-body">
                                    <div class="plan-list align-center">
                                        <ul class="list-group list-group-flush mbr-fonts-style display-7">
                                            ...
                                            <li class="list-group-item">Fiche Google My Business
                                            </li>
                                            <li class="list-group-item">Google Analytics
                                            </li>
                                            <li class="list-group-item">Nom de domaine &amp; e-mails (inclus)
                                            </li>
                                            <li class="list-group-item">Hébergement &amp; maintenance (inclus)</li>
                                        </ul>
                                    </div>
                                ...
                                <div class="plan-body">
                                    <div class="plan-list align-center">
                                        <ul class="list-group list-group-flush mbr-fonts-style display-7">
                                            ...
                                            <li class="list-group-item">Nom de domaine &amp; e-mails (option)
                                            </li>
