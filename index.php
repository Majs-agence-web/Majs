...
<div>les dernières technologies.</div></h4>
...
<div>à un niveau supérieur.</div></h4>
...
<section class="features1 realtym4_features1 cid-smrdZ8PbQu" id="features01-38">
    ...
    <style>
           ...
           #myBox:hover, #myBox2:hover, #myBox3:hover{
                cursor: pointer;
           }
        ...
        <div class="media-container-row">
            <div class="col-12 align-center">
                <h2 class="mbr-section-title pb-3 mbr-regular mbr-fonts-style display-1">
                    <span style="color: rgb(236, 201, 121);">{&nbsp;</span>Ils nous ont fait confiance&nbsp;<span style="color: rgb(236, 201, 121);">}&nbsp;</span></h2>
