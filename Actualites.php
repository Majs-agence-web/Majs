...
<section class="cid-sp5c04PyCv mbr-parallax-background" id="header02-5a">
    ...
    <div class="container align-center">
        <div class="row justify-content-md-start">
            <div class="mbr-white col-12 text-center mx-auto">
                <h1 class="mbr-section-title mbr-regular pb-3 align-center mbr-fonts-style display-1">Actualités</h1>                
            </div>
        </div>
    </div>   
</section>

<section class="features11 cid-sp5cTInzgS" id="features11-5f">
    <div class="container">
        <div class="row">            
            <div class="item features-image сol-12 col-lg-6">
                ...
                <div class="item-content">
                    ...
                    <p class="mbr-text mbr-fonts-style display-4 textActu">
                ...
                <div class="item-wrapper">                   
                    <div class="post_wrap text-primary">
                        <div class="card_post">
                            ...
                            <div class="published_post">
                                <p class="publish_date mb-0 mbr-fonts-style display-7">Publication</p>
                                <p class="date mb-0 mbr-fonts-style display-4"><strong>Avril 2021</strong></p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="item-img">             
                    <img src="assets/images/savings-2789112_640.webp" alt="" title="" data-slide-to="2" loading="lazy">                      
                </div>
                <div class="item-content">
                    <h3 class="mbr-section-subtitle mbr-medium mbr-fonts-style display-7">Combien coûte réellement la confection d’un site Internet? Explications et coûts cachés</h3>
                    <p class="mbr-text mbr-fonts-style display-4 textActu">
                        La majorité d’entre nous estime que le coût d’un site web se reflète principalement dans ce qui est facturé par le concepteur, que ce soit une agence ou un freelance. Cependant, un site internet ne peut pas simplement se résumer à une simple prestation de services. Dans cet article , nous allons tenter de vous éclairer sur les frais induits d’un site internet , pour illustrer l’adage bien connu : “Un client averti en vaut deux!” On n’y trouvera donc pas une liste exhaustive des dépenses prévisibles, mais plutôt des informations sur les frais cachés, de la conception à la production, afin que vous restiez maître de votre budget en toute connaissance de cause.
                    </p>
                    <div class="mbr-section-btn"><a class="btn btn-danger display-4" href="cout_site.php"><span class="mobi-mbri mobi-mbri-right mbr-iconfont mbr-iconfont-btn"></span>En savoir +<br></a></div>                    
                </div>
            </div>
        </div>
    </div>
