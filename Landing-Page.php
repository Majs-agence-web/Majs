...
<body>
    ...
    <section class="cid-smyb1ywgum mbr-parallax-background" id="header02-40">
        ...
        <div class="container align-center">
            <div class="row justify-content-md-start">
                <div class="mbr-white col-12 text-center mx-auto">
                    <h1 class="mbr-section-title mbr-regular pb-3 align-center mbr-fonts-style display-1">Site Landing Page</h1>
    ...
    <section class="cid-smyb1yURxL" id="content02-41">
        ...
        <div class="container">
            <div class="">
                <div class="align-center">
                    <img src="assets/images/landing1.svg" alt="">
                    <div>
                        ...
                        <p class="mbr-text mbr-light pt-4 mbr-fonts-style display-7">Plus communément appelé mini-site en Français, cet outil est l’idéal pour relayer une campagne publicitaire cela peut être aussi utile pour présenter votre activité.
                            ...
                            <br>• Une mise en page simple et efficace pour vos prospects&nbsp;<br>
                        </p>
    ...
    <section class="cid-smyb1zaqEp" id="content02-42">
        ...
        <div class="container">
            <div class="">
                <div class="align-center">
                    ...
                    <img src="assets/images/landing2.svg" alt="">
                    ...
                    <p class="mbr-text mbr-light pt-4 align-left mbr-fonts-style display-7"><strong><span style="font-size: 1.5em !important;">Une landing page en quelques phrases.</span><br></strong><br>C’est un mini site que l’on peut traduire littéralement en anglais comme page d’atterrissage.<br><br> Le but de ce genre de sites Web et d’être impactant sur une seule page pour un maximum d’inscrit ou de prospects.
                        ...
                        <br>- L’absence d’éléments superflus qui pourraient faire perdre la puissance au message.&nbsp;<br>
                    </p>
        ...
        <div class="container">
            <div class="row justify-content-md-center">
                <div class="col-md-10 col-sm-12">
                    ...
                    <div class="mbr-section-btn align-center"><a class="btn btn-md btn-danger display-4" href="Devis.php?site=landingPage">DEMANDER UN DEVIS</a></div>
                </div>
