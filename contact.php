...
<body>
    ...
    <section class="cid-smOvsYaB5P" id="title02-4y">
        ...
        <div class="container align-center">
            <div class="row justify-content-md-start justify-content-md-center">
                <div class="mbr-white col-sm-12 col-md-10 col-lg-7">
                    <h1 class="mbr-section-title mbr-regular align-center mbr-fonts-style display-1"><span style="color:#ecc979;">{&nbsp;</span>Formulaire de contact&nbsp;<span style="color:#ecc979;">}</span></h1>
            ...
            <div class="row">
                ...
                <div class="title col-md-12 col-lg-6">
                    ...
                    <div class="row justify-content-center">
                        <div class="title pt-5 col-md-12 col-lg-12">
                            <h2 class="mbr-section-title mbr-regular align-left pb-3 mbr-fonts-style display-5"><strong>Vous avez une idée de projet ? Partagez là nous.
                                </strong></h2>
                            <h3 class="mbr-section-title mbr-regular align-left pt-3 pb-3 mbr-fonts-style display-7">• Vous êtes un nouvel entrepreneur voulant créer une boutique en ligne ?<br><br>• Une entreprise souhaitant se développer sur internet ? <br><br>• Une entreprise cherchant une solution sur mesure ?<br><br>• A la recherche d'une optimisation en référencement naturel/payant, ergonomie ou e-mailing ?&nbsp;</h3>
                        </div>

                        <!--                     <div class="title col-md-6 col-lg-6">
                        <h3 class="mbr-section-title align-left mbr-fonts-style" mbr-theme-style="display-5">Working
                            Hours</h3>
                        <p class="mbr-text align-left mbr-semibold mbr-fonts-style" mbr-theme-style="display-4" data-app-selector=".mbr-text">9AM TO 8PM</p>
                    </div> -->
                        <!--                     <div class="title col-md-6 col-lg-6">
                        <h3 class="mbr-section-title align-left mbr-fonts-style" mbr-theme-style="display-5"></h3>
                        <p class="mbr-text align-left mbr-semibold mbr-fonts-style" mbr-theme-style="display-4" data-app-selector=".mbr-text"></p>
                    </div>
 -->
                        <div class="title col-md-6 col-lg-6">
                            <h3 class="mbr-section-title align-left mbr-fonts-style display-5">Email</h3>
                            <p class="mbr-text align-left mbr-semibold mbr-fonts-style display-4">contact@majs.fr</p>
                        </div>

                        <div class="title col-md-6 col-lg-6">
                            <h3 class="mbr-section-title align-left mbr-fonts-style display-5">Téléphone</h3>
                            <p class="mbr-text align-left mbr-semibold mbr-fonts-style display-4">07 70 39 27 93</p>
                        </div>
    ...
    <section class="clients cid-smOl1YBAZH" id="clients01-4p">
