...
<section class="pt-5"> 
    <div class="container text-center">
        <h6 class="main-title pb-5 mbr-regular mbr-fonts-style display-1" style="color:#355665;font-size:20px;line-height:1.3 !important"> 
        Pour l'<span style="color:#ff8a73;">Achat</span> de votre <span style="color:#ff8a73;">Site E-Commerce</span>, Majs vous conseille fortement de prendre notre forfait de maintenance <span style="color:#ff8a73;">"Confort"</span> à (partir de) 65€ HT/Mois</h6>
    </div>
</section>
