...
<head>
    ...
    <meta name="description" content="Le site vitrine est la solution idéale pour communiquer votre activité et présenter vos services à vos clients. MAJS Web Agency est là pour vous.">
        ...
        <div class="container align-center">
            <div class="row justify-content-md-start">
                <div class="mbr-white col-12 text-center mx-auto">
                    <h1 class="mbr-section-title mbr-regular pb-3 align-center mbr-fonts-style display-1">Le Site Vitrine</h1>          
                </div>
            </div>
        </div>
    </section>
...
<!-- Transition texte -->
    <section class="pt-5">  
        <div class="container text-center">
            <h6 class="main-title pb-5 mbr-regular mbr-fonts-style display-1" style="color:#355665;font-size:30px;"> Retrouvez ci-dessous l'ensemble des fonctionnalités de votre<span style="color:#ff8a73;"> Site Vitrine</span></span></h6>
        </div>
    </section>
<!-- Transition texte -->
                ...
                <table class="table table-bordered mb-0 pb-0" style="background-color:#fff;">
                    ...
                    <style type="text/css">
                        ...
                        <tbody>
                            ...
                            <!-- Modele Design 
                                <tr>
                                    <th scope="row" class="Typo TitreBlanc pt-3 pb-3 align-middle" data-toggle="tooltip" data-placement="top" title="" style="background-color: #ecc979; color:#fff; border-right:1px solid #ecc979 !important; font-size:18px;">Design 
                                        <span class="icon54-v4-information mbr-iconfont pl-2" style="font-size: 19px; color: #fff !important;"></span>
                                    </th>
                            ...
                            <!-- Modele Nombre de pages-->
                                ...
                                <tr>
                                    ...
                                    <td class="Typo TexteGris Center align-middle text-right">+ 5€/Page</td>
                                ...
                                <tr style="border-top:none !important; border-left:none !important;">
                                    ...
                                    <td scope="col" class="Typo Titre1 Center align-middle text-center" style="background-color:#fff; color:#355665; font-size:20px; font-weight:bold;">
                                        <div class="boutonDevis mx-auto navbar-buttons px-2">
                                            <a class="btn btn-sm btn-danger display-4" href="devis-site-vitrine-location.php">Devis gratuit / Location</a>
                                        </div> 
                                    </td>
                                    <td scope="col" class="Typo Titre1 Center align-middle text-center" style="background-color:#355665; color:#fff; font-size:20px; font-weight:bold;">
                                        <div class="boutonDevis mx-auto navbar-buttons px-2">
                                            <a class="btn btn-sm btn-danger display-4" href="devis-site-vitrine-achat.php">Devis gratuit / Achat</a>
                                        </div> 
                                    </td>
                                </tr>
                            <!-- -->
                            ...
                            <div class="container">
                                <table class="table table-bordered mb-0 pb-0" style="background-color:#fff;">
                                        ...
                                        <tbody>
                                            ...
                                            <!-- Modele Design
                                                <tr>
                                                    <th colspan="2" scope="row" class="Typo TitreBlanc pt-3 pb-3 align-middle" data-toggle="tooltip" data-placement="top" title="" style="background-color: #ecc979; color:#fff; border-right:1px solid #ecc979 !important; font-size:18px;">Design 
                                                    <span data-toggle="tooltip" data-placement="right" title="test test test testtesttest test test test test test test  test test test test  test testtest test test test test test test" 
                                                    class="icon54-v4-information mbr-iconfont pl-2" style="font-size: 19px; color: #fff !important;"></span>
                                                </th>
                                ...
                                <div class="container text-center pt-4">
                                    <div class=" container boutonDevis mx-auto navbar-buttons px-2">
                                        <a class="btn btnTest display-4" href="devis-site-vitrine-location.php">Devis gratuit / Location</a>
                                ...
                                <table class="table table-bordered mb-0 pb-0" style="background-color:#fff;">
                                        ...
                                        <tbody>
                                            ...
                                            <!-- Modele Design
                                                ...
                                                <tr>
                                                    <th scope="row" class="Typo TitreGris pt-3 pb-3 align-middle">Logo</th>
                                                    <td class="Typo TexteGris Center align-middle text-right" style="background-color:#355665;color: #fff; border-bottom-color: #fff !important;">Sur devis</td>
                                                </tr>
                                            ...
                                            <!-- Modele Nombre de pages-->
                                                ...
                                                <tr>
                                                    <th scope="row" class="Typo TitreGris pt-3 pb-3 align-middle">1 page</th>
                                                    <td class="Typo TexteGris Center align-middle text-right" style="background-color:#355665;color: #fff; border-bottom-color: #fff !important;">950€</td>
                                                </tr>

                                                <tr>
                                                    <th scope="row" class="Typo TitreGris pt-3 pb-3 align-middle">2 à 5 pages</th>
                                                    <td class="Typo TexteGris Center align-middle text-right" style="background-color:#355665;color: #fff; border-bottom-color: #fff !important;">+ 150€/Page</td>
                                                </tr>
                                            ...
                                            <!-- Modele Référencements
                                                ...
                                                <tr>
                                                    <th scope="row" class="Typo TitreGris pt-3 pb-3 align-middle">Naturel (SEO) <span class="icon54-v4-information mbr-iconfont pl-2" style="font-size: 19px; color: #355665;"></span></th>
                                                    <td class="Typo TexteGris Center align-middle text-right" style="background-color:#355665;color: #fff; border-bottom-color: #fff !important;">Inclus</td>
                                                </tr>
                                            ...
                                            <!-- Modele Hébergement
                                                ...
                                                <tr>
                                                    <th scope="row" class="Typo TitreGris pt-3 pb-3 align-middle">Nom de domaine<span class="icon54-v4-information mbr-iconfont pl-2" style="font-size: 19px; color: #355665;"></span></th>
                                                    <td class="Typo TexteGris Center align-middle text-right" style="background-color:#355665;color: #fff; border-bottom-color: #fff !important;">Offert</td>
                                                </tr>
                                            ...
                                            <!-- Modele Formation
                                                ...
                                                <tr>
                                                    <th scope="row" class="Typo TitreGris pt-3 pb-3 align-middle">Vidéo tutoriel <span class="icon54-v4-information mbr-iconfont pl-2" style="font-size: 19px; color: #355665;"></span></th>
                                                    <td class="Typo TexteGris Center align-middle text-right" style="background-color:#355665;color: #fff; border-bottom-color: #fff !important;">Offerte</td>
                                                </tr>
...
<!-- Description Site E-Commerce -->
            ...
            <div class="container">
                <div class="">
                    <div class="align-center">
                        <img src="assets/images/vitrine1.svg" alt="" loading="lazy">
                        <div>
    ...
    <!-- Paragraphe 2 -->
        <section class="cid-smxKUwt1AU" id="content02-3o">
            <div class="container align-center">
                <div class="">
                    <div class="align-center">         
                        <img src="assets/images/vitrine2.svg" alt="" loading="lazy">
                        <p class="mbr-text mbr-light pt-4 align-left mbr-fonts-style display-7"><strong><span style="font-size: 1.5em !important;">Un site vitrine en quelques phrases.</span><br></strong><br>Vous voulez communiquer votre activité sur le web et souhaitez présenter vos services à vos clients ?
                        <br><br>Le site vitrine est la solution idéale. MAJS agence web, vous accompagnera dans la création de votre site vitrine.
                        <br><br>Dans quel cas faut-il opter pour un site vitrine ?
                        <br><br>•	Présenter vos produits et/ou vos services (sans pour autant les vendre en ligne)
                        <br>•	Attirer de nouveaux clients
                        <br>•	Mettre en avant votre activité
                        <br>•	Augmenter la visibilité de votre entreprise
                        <br>
                        <br>Un site vitrine en quelques phrases.
                        <br></p>     
                    </div>      
                </div>
            </div>
    ...
    <!-- Paragraphe 3 -->
        <section class="cid-smxSoq9vGp" id="content02-3q">
            <div class="container align-center">
                <div class="">
                    <div class="align-center"> 
                        <img src="assets/images/commerce3.svg" alt="" loading="lazy"> 
