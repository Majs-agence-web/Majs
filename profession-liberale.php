...
<body>
    ...
    <section class="carousel slider1 slide testimonials-slider cid-sptrhyolYg" data-interval="false" id="slider1-64">
    ...
    <section class="mbr-section extContent cid-spss2SAbAb" id="extContent15-60">
    ...
    <section class="mbr-section article extСontent cid-spsrIa1PJI" id="extContent3-5z">
    ...
    <section class="mbr-section extContent cid-sptx86iggi" id="extContent15-65">
            ...
            <div class="row justify-content-center">
                <div class="col-md-10 col-sm-12 text-section">
                    <p class="mbr-fonts-style mbr-text align-center display-7" style="text-align:justify;">Aussi, concernant la communication, une certaine souplesse est appliquée (selon l’Ordre dont vous dépendez). Voilà quelques exemples de campagnes qui peuvent être admises :
                        ...
                        <br><br>Autre avantage, la LOA (location avec option d’achat) vous assure un accompagnement et un suivi de votre projet sur la durée de la location. Cela comprend : l’hébergement, la maintenance, les mises à jour, le renouvellement de votre nom de domaine.<br>
                    </p>
    ...
    <section class="clients cid-spsr5y6hiH" id="clients01-5w">
