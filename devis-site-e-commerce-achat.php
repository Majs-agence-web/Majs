...
<!-- Devis -->
    <section class="pt-5" data-form-type="formoid">
        <form action="" method="POST" data-form-title="site e-commerce achat">
            <div class="container">
                <table class="table table-bordered mb-0 pb-0" style="background-color:#fff;">
                    ...
                    <tbody>
                        ...
                        <!-- Modele Nbr Articles-->
                            ...
                            <tr>
                                <th scope="row" class="Typo TitreGris pt-3 pb-3 align-middle">Combien avez-vous de produit à vendre ?</th>
                                <td class="Typo TexteGris Center align-middle">
                                    <div class="row mb-2">
                                        <div class="col">
