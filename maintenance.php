...
<head>
    ...
    <meta name="description" content="L’agence Majs vous propose des packs qui répondront à vos besoins cela vous laisse une liberté pour réserver pleinement votre énergie à votre business.">
    ...
    <div class="container align-center">
        <div class="row justify-content-md-start">
            <div class="mbr-white col-12 text-center mx-auto">
                <h1 class="mbr-section-title mbr-regular pb-3 align-center mbr-fonts-style display-1">Maintenance</h1> 
            </div>
        </div>
    </div>
...
<section class="extFeatures cid-stMLFm0svP" id="extFeatures6-z">
    ...
    <div class="row justify-content-center pt-3">
        <div class="card zoom p-3 col-12 col-md-6 col-xl-4 col-lg-4">
            <div class="card-wrap">
                <div class="card-img pb-4 align-center">
                    <span class="mbr-iconfont icon54-v4-preferences-1" style="color: rgb(236, 201, 121); fill: rgb(236, 201, 121);"></span>
                </div>
                <div class="card-box">
                    <h4 class="card-title mbr-fonts-style align-center display-5"><strong>Mise à jour</strong></h4>
                    <p class="mbr-text mbr-fonts-style align-center display-7">
                        Mises à jour du CMS et des plugins. Test de compatibilité.           
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="card zoom p-3 col-12 col-md-6 col-xl-4 col-lg-4">
            <div class="card-wrap">
                <div class="card-img pb-4 align-center">
                    <span class="mbr-iconfont icon54-v4-save" style="color: rgb(236, 201, 121); fill: rgb(236, 201, 121);"></span>
                </div>
                <div class="card-box ">
        ...
        <div class="card zoom p-3 col-12 col-md-6 col-xl-4 col-lg-4">
            <div class="card-wrap">
                <div class="card-img pb-4 align-center">
                    <span class="mbr-iconfont icon54-v4-lock zoom"></span>
                </div>
                <div class="card-box">
                    <h4 class="card-title mbr-fonts-style align-center display-5">
                        Sécurité</h4>
        ...
        <div class="card zoom p-3 col-12 col-md-6 col-xl-4 col-lg-4">
            <div class="card-wrap">
                <div class="card-img pb-4 align-center">
                    <span class="mbr-iconfont icon54-v1-speed-meter"></span>
                </div>
                <div class="card-box">
                    <h4 class="card-title mbr-fonts-style align-center display-5">Performances</h4>
                    <p class="mbr-text mbr-fonts-style align-center display-7">
        ...
        <div class="card zoom p-3 col-12 col-md-6 col-xl-4 col-lg-4">
            <div class="card-wrap">
                <div class="card-img pb-4 align-center">
                    <span class="mbr-iconfont icon54-v4-trash-full"></span>
                </div>
                <div class="card-box">
                    <h4 class="card-title mbr-fonts-style align-center display-5">
                        Nettoyage</h4>
        ...
        <div class="card zoom p-3 col-12 col-md-6 col-xl-4 col-lg-4">
            <div class="card-wrap">
                <div class="card-img pb-4 align-center">
                    <span class="mbr-iconfont icon54-v1-firewall-on"></span>
                </div>
                <div class="card-box">
                    <h4 class="card-title mbr-fonts-style align-center display-5">
                        Firewall</h4>
        ...
        <div class="card zoom p-3 col-12 col-md-6 col-xl-4 col-lg-4">
            <div class="card-wrap">
                <div class="card-img pb-4 align-center">
                    <span class="mbr-iconfont icon54-v4-eye"></span>
                </div>
                <div class="card-box">
                    <h4 class="card-title mbr-fonts-style align-center display-5">Surveillance</h4>
                    <p class="mbr-text mbr-fonts-style align-center display-7">
        ...
        <div class="card zoom p-3 col-12 col-md-6 col-xl-4 col-lg-4">
            <div class="card-wrap">
                <div class="card-img pb-4 align-center">
                    <span class="mbr-iconfont icon54-v2-search-within-app"></span>
                </div>
                <div class="card-box">
                    <h4 class="card-title mbr-fonts-style align-center display-5">
                        Rapport détaillé</h4>
        ...
        <div class="media-container-row">
            <div class="card p-3 col-12 col-md-8 col-lg-4">
                <div class="card-img pb-4">
                    <span class="mbr-iconfont fa-hourglass-o fa" style="color: rgb(236, 201, 121); fill: rgb(236, 201, 121);"></span>
                </div>
                <div class="card-box">
            ...
            <div class="card p-3 col-12 col-md-8 col-lg-4">
                <div class="card-img pb-4">
                    <span class="mbr-iconfont fa-hourglass-3 fa" style="color: rgb(236, 201, 121); fill: rgb(236, 201, 121);"></span>
                </div>
                <div class="card-box">
            ...
            <div class="card p-3 col-12 col-md-8 col-lg-4">
                <div class="card-img pb-4">
                    <span class="mbr-iconfont fa-hourglass fa"></span>
                </div>
                <div class="card-box">
