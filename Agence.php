...
<body>
    ...
    <section class="header04 digitalm4_header04 cid-smxqkTSiip" id="header04-3l">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" class="fill-light-wrapper" preserveAspectRatio="none" viewBox="0 0 1070 52">
            <path class="couleurForm" d="M0,52V0S247,91,505,32c261.17-59.72,565-13,565-13V52Z"></path>
        </svg>


    </section>

    <section class="features1 cid-smx1ezvgt1" id="features04-3c">
        ...
        <div class="container-fluid">
            <div class="pb-5">
                <h4 class="card-title py-2 text-center mbr-fonts-style display-1"><span style="color:#ecc979;">{</span>&nbsp;Nos Compétences<span style="color:#ecc979;">}</span></h4>
    ...
    <section class="cid-smxgdnLBoy mbr-parallax-background" id="features09-3e">



        <div class="mbr-overlay" style="opacity: 0.7; background-color: rgb(46, 75, 88);"></div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 col-lg-12 col-12 py-4 m-auto">
                    ...
                    <!--                 <div class="card">
                    <div class="card-ico">
                        <span mbr-icon class="mbr-iconfont pt-1 ico1 mobi-mbri-success mobi-mbri"></span>
                    </div>
                    <div class="card-box">
                        <h4 class="card-title pb-1 align-left mbr-fonts-style" mbr-theme-style="display-5" data-app-selector=".card-title">
    ...
    <section class="cid-smxiWcCR73" id="features09-3f">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-lg-12 col-12 py-4 m-auto">
                    ...
                    <p class="mbr-text align-left mbr-light pb-4 pt-3 mbr-fonts-style display-7">Le web design est une branche du graphisme appliqué au monde du web (internet). Cette discipline est la création, le choix et l’utilisation d’éléments graphiques (dessins, photos, couleurs etc..) pour élaborer un support de communication.
                        ...
                        <br>
                        <br>- Création ou refonte de logo
                        <br>- Création de charte graphique
                        <br>- Création d’identité visuelle
                        <br>- Créations de bannières, animations et illustrations<br>- Création de maquette<br>
                    </p>
    ...
    <section class="cid-smxl0dcP6C mbr-parallax-background" id="features09-3h">
    ...
    <section class="cid-smxlBLps4x" id="features09-3i">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 col-lg-12 col-12 py-4 m-auto">
                    <h1 class="mbr-section-title mbr-regular pb-1 mbr-fonts-style display-2">- Webmarketing -</h1>
                    ...
                    <p class="mbr-text align-left mbr-light pb-4 pt-3 mbr-fonts-style display-7">Améliorer le positionnement de votre site dans les résultats de recherche grâce au référencement naturel afin que l'internaute vous trouvent plus facilement sur des requêtes stratégiques sur votre entreprise.
                        ...
                        <br>- 70 % des clics sur les résultats de recherche sont issus du référencement naturel.&nbsp;<br>
                    </p>
        ...
        <div class="container">
            <div class="media-container-row">
                <div class="title col-12 align-center">
                    <h2 class="pb-3 mbr-fonts-style display-1"><span style="color:#ecc979;">{</span>&nbsp;L'équipe&nbsp;<span style="color:#ecc979;">}</span></h2>
        ...
        <div class="container pt-3 mt-2">
            <div class="media-container-row">
                ...
                <div class="panel-item p-3">
                    ...
                    <div class="card-footer">
                        <div class="mbr-author-name mbr-semibold mbr-fonts-style display-5">
                            Jérome <br>Leclercq</div>
                        <small class="mbr-author-desc pt-3 mbr-regular mbr-fonts-style display-4">DEV FRONT / DESIGNER</small>
